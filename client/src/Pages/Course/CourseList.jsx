   ...
   <section id="root1" className="h-[100svh]">
    ...
    {/* BOOK TEST END */}
      ...
      <section className="flex flex-col gap-14 md:py-6 py-5 md:px-20 px-3 min-h-screen">
        <h1 className="md:text-4xl text-2xl w-fit text-black dark:text-white font-inter font-[500] after:content-[' '] relative after:absolute after:-bottom-3.5 after:left-0 after:h-1.5 after:w-[60%] after:rounded-full after:bg-[#00a8e8] dark:after:bg-blue-600">
          Explore the courses made by{" "}
          <span className="font-[600] font-lato text-[#00a8e8]">
            Industry experts
          </span>
        </h1>
        {/* course container */}
