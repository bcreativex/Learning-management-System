  ...
  return (
    <Layout>
      <section className="flex flex-col gap-6 items-center py-8 px-3 min-h-[100vh]">
        ...
        >
          <h1 className="text-center dark:text-[#009fe8] text-4xl font-bold font-inter">
            Login Page
          </h1>
          {/* email */}
          <InputBox
          ...
          <button
            type="submit"
            className="mt-2 bg-[#009fe8] text-white dark:text-base-200  transition-all ease-in-out duration-300 rounded-md py-2 font-nunito-sans font-[500]  text-lg cursor-pointer"
            disabled={isLoading}
          >
